<footer id="footer" class="m-0 border-0 bg-color-dark overflow-hidden">
    <div class="container">
        <div class="row py-5 custom-row-footer">
            <div class="col-12 col-sm-12 col-lg-3 d-flex align-items-start flex-column footer-column custom-footer-column-logo">
                <img alt="FIRNAS" style="position: relative;bottom:70px;margin-top:30px;" height="90px;" src="{{$setting->site_logo}}">
                <p class="d-block m-0 text-color-light">{{$setting->footer_text}}</p>
            </div>
                    ...
                    <div class="d-flex flex-nowrap flex-lg-wrap justify-content-start justify-content-lg-end align-items-start align-items-lg-center w-100 flex-column flex-lg-row mt-4 mt-lg-0 custom-container-info-socials">
                        ...
                        <ul class="social-icons custom-social-icons">
                            <li class="nav-link text-color-secondary font-weight-bold letter-spacing-05 text-color-hover-primarysocial-icons-instagram">
                                <a class="custom-bg-color-light-grey" href="https://instagram.com/ibnfirnas.om?igshid=YmMyMTA2M2Y=" target="_blank" title="Instagram">
                                    <i class="fab fa-instagram text-4 font-weight-semibold text-color-secondary"></i>
                                </a>
                            </li>
                            <li class="social-icons-twitter">
                                <a class="custom-bg-color-light-grey" href="https://twitter.com/DroneIbn" target="_blank" title="Twitter">
