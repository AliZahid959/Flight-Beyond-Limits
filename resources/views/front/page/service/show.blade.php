...
<body data-target="#header" data-spy="scroll" data-offset="100">
    <div class="body">
        ...
        <section
            ...
            style="background-image: url({{ $service->banner_service_image }}); background-position:center;height:500px;">
            <div class="container">
                <div class="row mt-5">
                    <div class="col-md-12 align-self-center p-static order-2 text-center">
                        <h1 class="text-9 font-weight-bold">{{ $service->service_name }}</h1>
                    </div>
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb breadcrumb-light d-block text-center mt-5">
                            <li><a href="{{ url('/') }}">Home</a></li>
                            <li><a href="{{ route('front.page.services') }}">Services</a></li>
                            <li class="active"></li>
                        </ul>
                    </div>
                </div>
        ...
        <div role="main" class="main">
                        ...
                        <div class="col-lg-6 col-12">
                            <h1
                                ...
                                <strong
                                    ...
                                    data-appear-animation-delay="1200">{{ $service->service_name }}</strong>
                            </h1>
                            <p
                            ...
                            {{-- <p class="font-weight-light text-5 text-center text-sm-right mb-4" ></p>
								<div class="d-flex flex-column flex-sm-row align-items-center justify-content-end mb-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1600">
									...
									<span class="text-color-primary font-weight-bold text-11 my-3 my-sm-0 mx-4">{{$product->price}}</span>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-product-image-style-1 d-none d-lg-block">
                                <div data-plugin-float-element
                                    ...
                                    <img src="{{ $service->thumbnail_service_image }}"
                                        style="height: auto; width:300px;  margin-left:80px;margin-top:50px;"
                        ...
                        <div class="col-lg-12 col-xl-12 mb-lg-4">
                            <div class="overflow-hidden mb-1">
                                <div class="appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="500">
                                    <span class="d-block text-color-light custom-letter-spacing-1 text-3-5 opacity-5 mb-0">Service</span>
                                </div>
                            </div>
                            <h2 class="text-color-light font-weight-bold ls-0 text-9 mb-4">{{$service->service_name}}</h2>
                            <p class="text-3-5 text-color-light opacity-5">{!!$service->body!!}</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            @if ($setting->service_enable)
                <section id="our_services"
                    class=" bg-color-quaternary section py-3 section-height-4 border-0 m-0 appear-animation"
                            ...
                            <div class="col text-center">
                                {{-- <div class="overflow-hidden">
                                    <span
                                        ...
                                        data-appear-animation="maskUp">{{ $setting->service_title }}</span>
                                </div> --}}
                        ...
                        <div class="featured-boxes featured-boxes-style-4 custom-featured-boxes-style-1">
                            <div class="row">
                                <div class="col text-center">
                                    <div class="overflow-hidden">
                                        <h2 class="text-color-primary font-weight-bold mb-0 appear-animation"
                                            data-appear-animation="maskUp">Our other Services
                                        </h2>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row py-5 custom-row-footer">
                    <div
                        ...
                        <img alt="FIRNAS" style="position: relative;bottom:70px;margin-top:30px;" height="90px;"
                            src="{{ asset('front/assets/img/white.png') }}">
                        <p class="d-block m-0 text-color-light">Dar Al Manal Building, Office Number 402 4th Floor
