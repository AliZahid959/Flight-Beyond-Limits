...
@section('content')
    ...
    <form action="{{ route('home-slider.update', $home_slider) }}" method="POST" enctype="multipart/form-data">
        @method('patch')
        @csrf
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 my-2">
                                @if ($home_slider->slider_video)
                                <div class="col-12">
                                    <img src="{{ $home_slider->slider_video }}" width="81px" height="120px" alt="">
                                </div>
                            @endif
                                <label>slide Video</label>
