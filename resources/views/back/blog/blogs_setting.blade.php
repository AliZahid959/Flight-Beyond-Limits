        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Blogs Page Setting</h5>
                </div>
            </div>
        </div>
    </div>
    <form action="{{ route('setting.blog') }}" method="POST" enctype="multipart/form-data">
        @method('patch')
        @csrf
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="form-label" for="blog_title">Blogs Section Title</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i class="bx bx-user"></i></span>
                                        <input type="text"
                                            class="form-control @error('blog_title') is-invalid @enderror"
                                            name="blog_title" value="{{$setting->blog_title}}">
                                        @error('blog_title')
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="form-label" for="blog_btn_text">Blog Button Text</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i class="bx bx-user"></i></span>
                                        <input type="text"
                                            class="form-control @error('blog_btn_text') is-invalid @enderror"
                                            name="blog_btn_text" value="{{$setting->blog_btn_text}}">
                                        @error('blog_btn_text')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input class="form-check-input" type="checkbox" name="blog_enable" value="1" id="blog_enable" {{$setting->blog_enable ? 'checked' : ''}}>
