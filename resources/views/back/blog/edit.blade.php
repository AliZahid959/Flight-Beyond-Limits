                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                @if ($blog->thumbnail_blog_image)
                                    <div class="col-12">
                                        <img src="{{ $blog->thumbnail_blog_image }}" width="81px" height="120px"
                                            alt="">
                                    </div>
                                @endif
                                <div class="mb-3">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('body') is-invalid @enderror" name="body" id="body">{{ $blog->body }}</textarea>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text"
                                            ...
                                            name="author_email" value="{{ $blog->author_email }}">
                                        @error('author_email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="author_description" class="form-control">{{ $blog->author_description }}</textarea>
                                    @error('author_image')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="meta_keyword[]" id="meta_keyword" multiple>
                                        @foreach ($blog->meta_keyword as $item)
