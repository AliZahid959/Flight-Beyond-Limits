        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Product Page Setting</h5>
                </div>
            </div>
        </div>
    </div>
    <form action="{{ route('setting.product') }}" method="POST" enctype="multipart/form-data">
        @method('patch')
        @csrf
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="form-label" for="product_title">Product Section Title</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i class="bx bx-user"></i></span>
                                        <input type="text"
                                            class="form-control @error('product_title') is-invalid @enderror"
                                            name="product_title" value="{{$setting->product_title}}">
                                        @error('product_title')
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="form-label" for="service_btn_text">Product Button Text</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i class="bx bx-user"></i></span>
                                        <input type="text"
                                            class="form-control @error('product_btn_text') is-invalid @enderror"
                                            name="product_btn_text" value="{{$setting->product_btn_text}}">
                                        @error('product_btn_text')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        @enderror
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input class="form-check-input" type="checkbox" name="product_enable" value="1" id="product_enable" {{$setting->product_enable ? 'checked' : ''}}>
                                        <label class="form-check-label ms-2" for="product_enable"> Enable Section </label>
                                    </div>
                                </div>
                            </div>
                        </div>
