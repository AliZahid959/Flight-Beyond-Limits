...
@section('content')
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Academy Page Setting</h5>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <form action="{{ route('setting.academy') }}" method="POST" enctype="multipart/form-data">
                @method('patch')
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label" for="academy_mail">Academy Email</label>
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"><i class="bx bx-user"></i></span>
                                                <input type="email"
                                                    class="form-control @error('academy_mail') is-invalid @enderror"
                                                    name="academy_mail" value="{{$setting->academy_mail}}">
                                                @error('academy_mail')
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label" for="academy_no">Academy Contact No: </label>
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"><i class="bx bx-user"></i></span>
                                                <input type="text"
                                                    class="form-control @error('academy_no') is-invalid @enderror"
                                                    name="academy_no" value="{{$setting->academy_no}}">
                                                @error('academy_no')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3 mt-3">
                                            <label class="form-label" for="about_content">About Content</label>
                                            <div class="input-group input-group-merge">
                                                <span class="input-group-text"><i class="bx bx-user"></i></span>
                                                <input type="text"
                                                    class="form-control @error('about_content') is-invalid @enderror"
                                                    name="about_content" value="{{$setting->about_content}}">
                                                @error('about_content')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
