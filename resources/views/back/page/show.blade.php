...
@section('content')
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">{{$page->page_name}}</h5>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            ...
            <form action="{{ route('page.manager', $page) }}" method="POST">
                @method('patch')
                @csrf
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">{{ $page->page_name }} Page Manager</h5>
                    </div>
                </div>
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="form-label" for="body">Page Body</label>
                                    <textarea type="text" class="form-control @error('page_name') is-invalid @enderror"name="body"></textarea>
                                    @error('body')
