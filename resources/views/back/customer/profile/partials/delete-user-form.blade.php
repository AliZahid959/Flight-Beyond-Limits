<section class="space-y-6">
    ...
    <danger-button data="" on:click.prevent="$dispatch('open-modal', 'confirm-user-deletion')">
    ...
    <modal name="confirm-user-deletion" :show="$errors - > userDeletion - > isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6">
                ...
                <text-input id="password" name="password" type="password" class="mt-1 block w-3/4"
            ...
            <div class="mt-6 flex justify-end">
                <secondary-button on:click="$dispatch('close')">
                    {{ __('Cancel') }}
                </secondary-button>
