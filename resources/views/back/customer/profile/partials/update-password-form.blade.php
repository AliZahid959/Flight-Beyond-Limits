<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <text-input id="current_password" name="current_password" type="password" class="mt-1 block w-full"
        ...
        <div>
            ...
            <text-input id="password" name="password" type="password" class="mt-1 block w-full"
        ...
        <div>
            ...
            <text-input id="password_confirmation" name="password_confirmation" type="password"
        ...
        <div class="flex items-center gap-4">
            ...
            @if (session('status') === 'password-updated')
                <p data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 2000)"
