...
@section('content')
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header">
                    <form action="{{ route('course-category.destroy', $courseCategory) }}" method="post">
                        @csrf
                        @method('delete')
    ...
    <form action="{{ route('course-category.update' , $courseCategory) }}" method="POST" enctype="multipart/form-data">
        @method('patch')
        @csrf
        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control @error('category_name') is-invalid @enderror"
                                            name="category_name" value="{{$courseCategory->category_name}}">
                                        @error('category_name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="status">
                                            <option value="Publish" {{$courseCategory->status == 'Publish' ? 'selected' : ''}}>Publish</option>
                                            <option value="Draft" {{$courseCategory->status == 'Draft' ? 'selected' : ''}}>Draft</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
