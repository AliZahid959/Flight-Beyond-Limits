	...
	*/
	var ajaxOnPage = {
		...
		build: function() {
			...
			$('a[data-ajaon-page]').each(function() {
				self.add($(this));
			});

			$(document).on('mousedown', 'a[data-ajaon-page]', function (ev) {
				if (ev.which == 2) {
					ev.preventDefault();
					return false;
				}
	...
	Ajax on Modal
	*/
	theme.fn.execOnceTroughEvent( 'a[data-ajaon-modal]', 'mouseover.trigger.ajax.on.modal', function(){
		$('a[data-ajaon-modal]').magnificPopup({
			type: 'ajax',
			tLoading: '<div class="bounce-loader"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>',
			mainClass: 'portfolio-ajamodal',
			closeBtnInside: true,
			gallery: {
				enabled: true
			},
			callbacks: {
				ajaxContentAdded: function() {
					...
					// Wrapper
					var $wrapper = $('.portfolio-ajamodal');
					...
					if($('a[data-ajaon-modal]').length <= 1) {
